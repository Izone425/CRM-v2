<div class="p-6 bg-white rounded-lg shadow" wire:poll.1s>
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-2">
            ...
            <h2 class="text-lg font-bold text-gray-800">Inactive</h2>
        </div>
        <span class="text-lg font-bold text-gray-500">Total: {{ $totalInactiveLeads }}</span>
    </div>
    ...
    <div class="flex justify-center space-x-8">
        @foreach ($statusData as $status => $count)
            @php
                ...
                $color = match($status) {
                    'Closed' => '#10B981',  // Green
                    'Lost' => '#C0C0C0',    // Light Gray
                    'On Hold' => '#6B7280',  // Medium Gray
                    'No Response' => '#71797E', // Dark Gray
