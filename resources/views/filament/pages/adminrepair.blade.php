...
<div id="admin-repair-container" class="hardware-handover-container"
     x-data="{
         selectedSection: null,

         setSelectedSection(value) {
             console.log('Setting admin repair section to:', value);
         ...
         init() {
             console.log('Admin repair Alpine component initialized');
             this.selectedSection = null;
         }
     }"
     x-init="init()">
