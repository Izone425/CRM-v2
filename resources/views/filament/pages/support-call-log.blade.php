    ...
    <div class="mb-6">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card card-completed">
                <div class="card-value">{{ \App\Models\CallLog::where('task_status', 'Completed')->count() }}</div>
                <div class="card-label">Completed Tasks</div>
            </div>

            <div class="summary-card card-pending">
                <div class="card-value">{{ \App\Models\CallLog::where('task_status', 'Pending')->count() }}</div>
