    ...
    <div class="training-setting-container">
        ...
        <div class="header-controls">
            <div class="trainer-info">
                <h2 class="trainer-title">🎓 Trainer 1 Schedule</h2>
                <span class="trainer-subtitle">Manage training sessions for Trainer 1</span>
            </div>
        ...
        @if($showCalendar)
            <div class="calendar-container">
                <h2 class="calendar-title">{{ $selectedYear }} Training Schedule - Trainer 1 - Quarterly View</h2>
                                                ...
                                                @if($week['session'])
                                                    <div class="session-content">
                                                        <div class="session-title">
                                                            <span class="session-name">{{ $week['session']->session_number }} - Trainer 1</span>
    ...
    @endforeach
        ...
        @if($showCategoryModal)
            <div class="modal-overlay">
                <div class="modal-container">
                    <div class="modal-header">
                        <h3>Create Microsoft Teams Meetings - Trainer 1</h3>
